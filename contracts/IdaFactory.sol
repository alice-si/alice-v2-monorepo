...
contract IdaFactory {
  ...
  function createIda(
    ...
    Ida ida = new Ida(_paymentToken, promiseToken, escrow, claimsRegistry, _name, _outcomesNumber, _outcomesPrice, _validator, _arbiter, _validationCoolOffPeriod, _endTime, msg.sender);
