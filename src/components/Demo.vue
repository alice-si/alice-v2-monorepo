...
<template>
  <div class="page-container">
    ...
    <md-drawer class="md-right" md-swipeable :md-active.sync="logs.show">
      <md-toolbar class="md-transparent" md-elevation="0">
        <span class="md-title">Logs</span>
      </md-toolbar>

      <md-list>
        <md-list-item md-expand v-for="log in logs.list" v-bind:key="log.tx">
...
<style lang="scss" scoped>
  ...
  .md-title .md-icon.md-theme-default.md-icon-font {
    color: white;
  }
